...
@---------------------------------------------------------------------------------
	...
	@-------------------------------------------------------------------------
	@ Region 5 - DTCM (fincs-edit: was region 3, DTCM MUST have priority over GBA slot)
	@-------------------------------------------------------------------------
	ldr	r0,=__dtcm_start
...
setregions:
	...
	@-------------------------------------------------------------------------
	@ Region 3 - DS Accessory (GBA Cart) / DSi switchable iwram (fincs-edit: was region 5)
	@-------------------------------------------------------------------------
