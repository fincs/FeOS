...
BEGIN_TABLE(FEOSDSAPI)
	...
	ADD_FUNC(keysHeld),
	ADD_FUNC(keysUp),
	ADD_FUNC(keysDownRepeat),
	ADD_FUNC(keysSetRepeat),
	ADD_FUNC_ALIAS(FeOS_KeysUpdate, scanKeys),
	ADD_FUNC(FeOS_GetStylusPos),
	ADD_FUNC_ALIAS(FeOS_SetInterrupt, irqSet),
	ADD_FUNC(FeOS_CheckPendingIRQs),
	ADD_FUNC(FeOS_WaitForIRQ),
	ADD_FUNC(FeOS_SetIRQWaitFunc),
	ADD_FUNC(FeOS_NextIRQ),
	ADD_FUNC_ALIAS(FeOS_swi_IrqDisable, irqDisable),
	ADD_FUNC_ALIAS(FeOS_swi_IrqEnable, irqEnable),
